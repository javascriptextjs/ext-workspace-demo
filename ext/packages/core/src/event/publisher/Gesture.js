...
Ext.define('Ext.event.publisher.Gesture', {
    ...
    invokeRecognizers: function(methodName, e) {
        ...
        for (i = 0; i < ln; i++) {
            ...
            if (recognizer.isActive && !e.isStopped && recognizer[methodName].call(recognizer, e) === false) {
    ...
    doDelegatedEvent: function(e) {
        ...
        // recognition.
        //
        // Also allow handlers set the cancelGesture prtoperty to cancel gesture recognition.
        if (e && !e.cancelGesture) {

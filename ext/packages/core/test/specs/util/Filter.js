describe("Ext.util.Filter", function () {
    ...
    describe('creating filter functions', function () {
        ...
        describe('generatedFilterFn property', function () {
            function doTest(cfg, msg, expectValue) {
                it(msg, function () {
            ...
            doTest({
                property: 'name',
                value: 'Ed'
            }, 'should mark as generated when a filterFn is not defined', true);

            doTest({
                filterFn: Ext.emptyFn
            }, 'should not mark as generated when a filterFn is defined', undefined);
        });

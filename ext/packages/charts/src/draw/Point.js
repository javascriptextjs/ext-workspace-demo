...
Ext.define('Ext.draw.Point', {
     ...
     *
     * @param x {Number/Number[]/Object/Ext.draw.Point}
     * @param y {Number/Number[]/Object/Ext.draw.Point}
     */
     ...
     * @param length {Number} [length=1] The length of the normalized vector. Defaults to 1.
     * @return {Ext.draw.Point}
     */

/* global expect, jasmine, Ext, spyOn, xdescribe */
...
describe("Ext.menu.Menu", function() {
    ...
    describe('Multi level menus', function() {
        ...
        it('should hide on click, and on reshow of parent, should not show again', function() {
            ...
            //\\ Right now, disabled child focusables are skipped by FocusableContainer
            //\\ TODO: When we are fully ARIA compliant, disabled menu items must focus.
            ...
            waitsFor(function() {
                return menu3.isVisible() && menu3Item1.hasFocus;
            }, 'menu3Item1 to recieve focus');
            ...
            runs(function() {
                ...
                jasmine.fireMouseEvent(menu3Item1.el, 'click');
            });
